...
export const actions = {
    ...
    setUsersTotalCount: (totalUsersCount: number) => ({ type: 'SET_TOTAL_PAGES', count: totalUsersCount }  as const),
    toggleFetching: (isFetched: boolean) => ({ type: 'TOGGLE_IS_FETCHING', isFetching: isFetched }  as const),
    toggleIsFollowingProgres: (isFetched: boolean, userId: number) => ({ type: 'TOGGLE_IS_FOLLOWING_PROGRES', isFetched: isFetched, userId }  as const),
} 
