...
class LoginForm extends React.Component {
    ...
    validationSchema = yup.object().shape({
        password: yup.string().typeError('should be a string').max(13, 'max 8 characters').min(2, 'min 2 characters').required('required'),
        ...
        return (
            <div>
                ...
                <Formik
                    ...
                    validateOnBlur
                    onSubmit={(values) => 
                    { this.props.login(values.email, values.password, values.rememberMe, values.captcha) }}
                ...
                >
                    ...
                    <div>
                        ...
                        {this.props.captchaUrl &&
                            <div>
                                <div><img src={this.props.captchaUrl} className={s.captcha}/></div>
                                <Field 
                                    type={'text'}
                                    name={'captcha'}
                                    onChange={handleChange}
                            ...
                            <div>   {this.props.userId == 'something went wrong' && <div><h4>Common error</h4></div>}
                                    {errors.captcha && <div><h4>{errors.captcha}</h4></div>}
                            </div>
                        </div>
